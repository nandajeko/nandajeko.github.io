$(document).ready(function () {
  ...
  function resizeSVG(svgWidth, svgHeight, svgTop, svgLeft) {
    $("#xmas, #intro, #windowOutlines").height(svgHeight).width(svgWidth).css({ left: svgLeft, top: svgTop });
  }
  ...
  function getMainTimeline() {
    ...
    tlClear
      .set([$windowRight, $banner, $windowLeft, $Tree, $star, $StarLight, $ShadowTree, $MouseInTree, $BaublesStriped, $BaublesFlat, $BaublesString, $BaublesStringString, $MouseRight, $MouseLeft], { autoAlpha: 0 })
    ...
    tlIntro.set($intro, { xPercent: 40, yPercent: 30, scale: 3, transformOrigin: "right bottom" }).from($intro, 2, { autoAlpha: 0 }).to($outline, 4, { strokeDashoffset: 0 }, "3");

    /* Blink */
    tlBlink = new TimelineMax({ repeat: -1, repeatDelay: 2 });
    tlBlink
      .set($mouseDarkBlack, { xPercent: -70 })
    ...
    tlOutline
      .to([$mouseDark], 0.3, { yPercent: 50, autoAlpha: 0, ease: Back.easeIn })
    ...
    tlStarLight
      .fromTo($StarLight, 0.6, { autoAlpha: 0.2 }, { autoAlpha: 1, rotation: 10, transformOrigin: "center center" }, "+=0.8")
    ...
    tlLogos
      .fromTo($logo, 0.4, { xPercent: -300, immediateRender: true }, { xPercent: 0, ease: Power4.easeOut, autoAlpha: 1 })
    ...
    tlHighlightShare.staggerTo($sIcons, 0.6, { rotation: 360, transformOrigin: "center center", ease: Power4.easeOut }, 0.1).staggerTo($sIconsPath, 0.6, { fill: "#ffffff" }, 0.1, "0");
    ...
    tlPresents
      .set([$Presents, $PresentA, $PresentB, $PresentC, $MouseRight], { autoAlpha: 1 })
    ...
    tlMouseInTree
      ...
      .staggerFromTo(
        ...
        0.1,
        { rotation: 0, transformOrigin: "top bottom", ease: RoughEase.easeInOut },
        { rotation: 2, transformOrigin: "top bottom", ease: RoughEase.easeInOut, repeat: 4 },
        0.05
      )
    ...
    tlMouseAway
      .to([$MouseInTree, $Lolypop2], 0.2, { autoAlpha: 0, scale: 0.5, ease: Power1.easeIn })
    ...
    mainTimeline.add(tlClear).add(tlIntro, "intro").add(tlBlink, "intro").add(tlOutline, "intro+=6").add(tlTree, "intro+=9").add(tlTreeGrow, "intro+=12");
  ...
  $box.mouseenter(function () {
    ($PresentBox = $(this).find(".PresentBox")), ($PresentBoxShadow = $(this).find(".PresentBoxShadow"));
  ...
  $box.click(function () {
    ...
    tlOpenPresent
      ...
      .to($socialLinkP, 0.6, { scale: 1.4, yPercent: -130, transformOrigin: "top center", ease: Power4.easeInOut }, "-=2.5");
